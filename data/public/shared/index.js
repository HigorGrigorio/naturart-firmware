...
const httpError = (arg) => {
  if (arg === 400) {
    ...
    setHttpMessage(
      "Obtivemos problemas ao processar os dados, tente novamente mais tarde.",
      true
    );
  } else {
    setHttpMessage(
      `Ocorreu um erro inesperado, tente novamente mais tarde. Codigo: ${arg}`,
      true
    );
  }
};

const adaptHttpFetchHandling = () => {
  return (response) => {
